...
{
    std::string str = "https://user:pass@subdomain.example.com:443/path/to/my%2dfile.txt?id=42&name=John%20Doe+Jingleheimer%2DSchmidt#page%20anchor";
...
{
    //int r1 = http_client(argc, argv);
    int r2 = url(argc, argv);
